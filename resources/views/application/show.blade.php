                    ...
                    <tr>
                        <td>
                            <div class="d-flex justify-content-center">
                                <img class="img-responsive p-2" src="{{ asset('/img/logo_n.png')}}" width="200px" alt="Logo">
                            </div>
                        </td>
                    </tr>
                </thead>
                        ...
                        <td>
                            <div class="application-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <span class="d-flex border border-top-0 border-left-0 border-right-0">1</span>
                                            <span>(Source)</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <span class="d-flex border border-top-0 border-left-0 border-right-0">XXXX</span>
                                            <span>(Amount)</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <span class="d-flex border border-top-0 border-left-0 border-right-0">2</span>
                                            <span>(Source)</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                        ...
                        <td>
                            <div class="application-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <span class="d-flex border border-top-0 border-left-0 border-right-0">.</span>
                                            <span>Signature</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
